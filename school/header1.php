                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul id="nav" class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu">
                          <li onclick="unhide('examfrm')"><a href="#">View Exams</a></li>
                          <li onclick="unhide('slipfrm')"><a href="#">Generate class list</a></li>
                        </ul>
                      </li>

                        <li><a href="home.php#students">Students</a></li>
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="cookiekill.php">Logout</a></li>
                        </ul>
                      </li>
